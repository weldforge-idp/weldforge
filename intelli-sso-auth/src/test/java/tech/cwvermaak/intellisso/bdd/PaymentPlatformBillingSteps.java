...
import tech.cwvermaak.intellisso.repository.SubscriptionRepository;
import tech.cwvermaak.intellisso.repository.TenantRepository;
import tech.cwvermaak.intellisso.service.audit.AuditService;
import tech.cwvermaak.intellisso.service.payment.FeeCalculator;
import tech.cwvermaak.intellisso.service.payment.OrderService;
import tech.cwvermaak.intellisso.service.payment.PaymentRoutingService;
import tech.cwvermaak.intellisso.service.payment.TenantProvisioningService;
    ...
    public void serviceAccountExists(String slug) {
        ...
        assertThat(serviceAccounts.stream()
                .anyMatch(sa -> sa.getTenant() != null
                        ...
                        && sa.getAdminRole() == tech.cwvermaak.intellisso.model.AdminRole.TENANT_ADMIN
