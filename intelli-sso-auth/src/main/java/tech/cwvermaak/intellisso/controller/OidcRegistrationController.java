...
import tech.cwvermaak.intellisso.model.dto.OidcClientDto;
...
import tech.cwvermaak.intellisso.service.oidc.OidcClientService;
...
public class OidcRegistrationController {
    ...
    public ResponseEntity<Map<String, Object>> register(
        ...
        auditService.recordAnonymous(AuditEventTypes.OIDC_CLIENT_DYNAMIC_REGISTER,
                tech.cwvermaak.intellisso.model.AuditEvent.Outcome.SUCCESS,
                tenant.getId(), null,
