...
public class AdminController {
    ...
    public ResponseEntity<UserResponseDto> setAdminRole(@PathVariable Long id,
        ...
        tech.cwvermaak.weldforge.model.AdminRole role;
        try {
            role = tech.cwvermaak.weldforge.model.AdminRole.valueOf(raw);
    ...
    public ResponseEntity<java.util.Map<String, Object>> inviteUser(
        ...
        var result = adminService.inviteUser(new tech.cwvermaak.weldforge.service.AdminService.InviteRequest(
