...
public class AdminService {
     ...
     */
    @Transactional
    public UserResponseDto setAdminRole(Long targetUserId, tech.cwvermaak.weldforge.model.AdminRole newRole) {
        ...
        target.setSuperAdmin(newRole == tech.cwvermaak.weldforge.model.AdminRole.SUPER_ADMIN);
    ...
    public InviteResult inviteUser(InviteRequest req) {
        ...
        User user = User.builder()
                ...
                .adminRole(req.isSuperAdmin()
                        ...
                        : tech.cwvermaak.weldforge.model.AdminRole.NONE)
                .role(role)
                .active(true)
                .tokenVersion(0)
                .build();
