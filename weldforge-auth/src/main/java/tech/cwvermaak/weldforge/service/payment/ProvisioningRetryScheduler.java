...
public class ProvisioningRetryScheduler {
    ...
    private final Map<tech.cwvermaak.weldforge.model.payment.GatewayProvider, PaymentGatewayStrategy> strategies;
    ...
    public ProvisioningRetryScheduler(PendingOrderRepository pendingOrderRepository,
        ...
        this.strategies = new EnumMap<>(tech.cwvermaak.weldforge.model.payment.GatewayProvider.class);
    ...
    private void issueRefundAndMark(PendingOrder order) {
        try {
            ...
            List<tech.cwvermaak.weldforge.model.payment.BillingTransaction> txs =
